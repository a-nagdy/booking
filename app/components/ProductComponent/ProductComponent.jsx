      ...
      <div class="container mx-auto px-4">
          ...
          <ol role="list" class="flex items-center">
            <li class="text-left">
              <div class="-m-1">
                <a
                  href="#"
                  class="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-100 focus:shadow hover:text-gray-800"
                >
                  {" "}
                  Home{" "}
                </a>
        ...
        <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <h2 class="mt-8 text-base text-gray-100">Coffee Type</h2>
            ...
            <h2 class="mt-8 text-base text-gray-100">Choose subscription</h2>
            <div class="mt-3 flex select-none flex-wrap items-center gap-1">
              <label class="">
                <input
                  type="radio"
            ...
            <ul class="mt-8 space-y-2">
              <li class="flex items-center text-left text-sm font-medium text-gray-100">
                <svg
                  class="mr-2 block h-5 w-5 align-middle text-gray-100"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
